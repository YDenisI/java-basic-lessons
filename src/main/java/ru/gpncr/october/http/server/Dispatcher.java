...
import ru.gpncr.october.http.server.processors.*;
...
public class Dispatcher {
    ...
    public Dispatcher() {
        ...
        this.defaultInternalServerErrorProcessor = new DefaultInternalServerError();
        this.defaultBadRequestProcessor = new DefaultBadRequest();
    }
